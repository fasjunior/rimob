rimobApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/', {
    ...
    $routeProvider.when('/imovel/bairros/logradouros/imoveis/:SqBairro/:SqLogradouro', {
    ...
    $routeProvider.when('/imovel/bairros/logradouros/imoveis/:SqBairro/:SqLogradouro/:SqTipoimovel/:SqImovelrecadastramento', {
    ...
    $routeProvider.when('/imovel/bairros/logradouros/imoveis/:SqBairro/:SqLogradouro/:SqImovelrecadastramento', {
